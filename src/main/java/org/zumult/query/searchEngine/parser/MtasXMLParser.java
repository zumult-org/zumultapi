 ...
 * 
 *      protected Map<String, SortedSet<String>> relationKeyMap = new HashMap<>();
 *      protected Map<QName, MtasParserType<MtasParserMapping<?>>> relationTypes = new HashMap<>();
 *      protected Map<QName, MtasParserType<MtasParserMapping<?>>> relationAnnotationTypes = new HashMap<>();
 *      protected Map<QName, MtasParserType<MtasParserMapping<?>>> refTypes = new HashMap<>();
 *      protected Map<QName, MtasParserType<MtasParserMapping<?>>> groupTypes = new HashMap<>();
 *      protected Map<QName, MtasParserType<MtasParserMapping<?>>> groupAnnotationTypes = new HashMap<>();
 *      protected Map<QName, MtasParserType<MtasParserMapping<?>>> wordTypes = new HashMap<>();
 *      protected Map<QName, MtasParserType<MtasParserMapping<?>>> wordAnnotationTypes = new HashMap<>();
 *      protected Map<QName, MtasParserType<MtasParserVariable>> variableTypes = new HashMap<>();
 * 
 *      protected Collection<? extends String> recursiveCollect(String refId, Map<String, SortedSet<String>> relationKeyMap, int maxRecursion){...}
 *      protected QName getQName(String key) {...}
 * 
 * 
 *******************************************************************************/
...
abstract class MtasXMLParser extends MtasBasicParser {
  ...
  protected Map<String, SortedSet<String>> relationKeyMap = new HashMap<>(); //EF: private -> protected

  /** The q names. */
  private Map<String, QName> qNames = new HashMap<>();

  /** The relation types. */
  protected Map<QName, MtasParserType<MtasParserMapping<?>>> relationTypes = new HashMap<>(); //EF: private -> protected

  /** The relation annotation types. */
  protected Map<QName, MtasParserType<MtasParserMapping<?>>> relationAnnotationTypes = new HashMap<>(); //EF: private -> protected

  /** The ref types. */
  protected Map<QName, MtasParserType<MtasParserMapping<?>>> refTypes = new HashMap<>(); //EF: private -> protected

  /** The group types. */
  protected Map<QName, MtasParserType<MtasParserMapping<?>>> groupTypes = new HashMap<>(); //EF: private -> protected

  /** The group annotation types. */
  protected Map<QName, MtasParserType<MtasParserMapping<?>>> groupAnnotationTypes = new HashMap<>(); //EF: private -> protected

  /** The word types. */
  protected Map<QName, MtasParserType<MtasParserMapping<?>>> wordTypes = new HashMap<>(); //EF: private -> protected

  /** The word annotation types. */
  protected Map<QName, MtasParserType<MtasParserMapping<?>>> wordAnnotationTypes = new HashMap<>(); //EF: private -> protected

  /** The variable types. */
  protected Map<QName, MtasParserType<MtasParserVariable>> variableTypes = new HashMap<>(); //EF: private -> protected
  ...
  protected Collection<? extends String> recursiveCollect(String refId, Map<String, SortedSet<String>> relationKeyMap,
      int maxRecursion) {
