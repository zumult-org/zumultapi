...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:text">
        <table class="transcript table-sm" id="transcript-table">
    ...
    <xsl:template match="tei:annotationBlock">
        ...
        <xsl:variable name="SPEAKER_ABB" select="//tei:person[@xml:id=$SPEAKER_ID]/@n"/>
        ...
        <tr class="annotationBlock">
            ...
            <xsl:attribute name="class"><xsl:value-of select="concat(substring-before($SPEAKER_ABB, '_'), '-row')"/></xsl:attribute>
            ...
            <td>
                ...
                <xsl:attribute name="title" select="$SPEAKER_ABB"/>
                <xsl:choose>
                    <xsl:when test="starts-with($SPEAKER_ABB, 'Interviewer')">
                        <img src="img/microphone-stand-duotone.png" style="margin-right:10px"/>                        
                    </xsl:when>
                    <xsl:otherwise>
                        <img src="img/user-duotone.png" style="margin-right:10px"/>                                                
                    </xsl:otherwise>
                </xsl:choose>
                <!-- <xsl:value-of select="//tei:person[@xml:id=$SPEAKER_ID]/@n"/> -->
                <xsl:value-of select="substring-after($SPEAKER_ABB, '_')"/>                    
            </td>      
            <td>
                <table>
                    <tr>
                    ...
                    <tr>
                        <td class="translation">
                            <xsl:apply-templates select="tei:spanGrp[@type='translation']"/>
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <xsl:template match="tei:pc">
        <span><xsl:value-of select="text()"/><xsl:text> </xsl:text></span>
    </xsl:template>
