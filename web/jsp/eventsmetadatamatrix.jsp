...
<html>
    <head>
        ...
        <title>Event metadata matrix</title>
        <style type="text/css">
    ...
    <body>
        ...
        <%
            ...
            for (String corpusID : corpora){
                ...
                Set<MetadataKey> metadataForThisCorpus = corpus.getMetadataKeys(ObjectTypesEnum.EVENT);
