...
<!DOCTYPE html>
      ...
      <%
            RequestDispatcher dispatcher = getServletContext()
                .getRequestDispatcher("/jsp/zuViel.jsp");
...
<html>
    <head>
        ...
        <title><%= corpusID %> Transcript+</title>
        ...
        <div class="row">
                ...
                <div style="position:fixed">
                    ...
                    <div class="input-group mb-3 input-group-sm" style="padding-left:20px; padding-right:10px;">
                        <div class="input-group-prepend" style="width:90px;">
                            <span class="input-group-text" id="subtitletypelabel" title="Reference wordlist">Ref wordlist</span>
                        </div>
                        <select class="form-control" id="refwordlist" onchange="changeRefWordlist()">
                          <option value="NONE">None</option>
                          
                          <% String[] wordlistIDs = Constants.LEIPZIG_WORDLISTS;
                                for (String id : wordlistIDs){%>
                                <option value="<%= id %>"
                                    <% if (wordlistID.equals(id)) {%>
                                        selected="selected"
                                    <% } %>
                                >
                                <%= id %>
                    ...
                    <div class="wordlist">                    
                        <div id="wordlist-container">
                            ...
                            <p style="color:gray">Please wait -- wordlist is loading.</p>                            
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-6" id="columnCenter">
                ...
                <div class="container" id="transcript-container">
                    <%//= transcriptHTML %>
                    <i class="fas fa-spinner fa-spin"></i>
                    <p style="color:gray">Please wait -- transcript is loading.</p>
                </div>
                ...
                <div style="position: fixed;">                    
                    ...
                    <div class="svg-wrapper">
                        <div id="svg">
                            <%//= transcriptSVG %>
                            <i class="fas fa-spinner fa-spin"></i>
                            <p style="color:gray">Please wait -- density viewer is loading.</p>                                
                        </div>                        
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="background: #f8f9fa; height: 270px; border-radius: 3px; padding: 3px;">
                                            <a href="javascript:addVideoImageToCollection('<%= videos.get(0) %>')" title="Add video image to collection" style="color:black">
                                                <i class="far fa-plus-square"></i>
                                            </a><br/>          
                                            <a href="javascript:getVideoImage('<%= videos.get(0) %>')" title="Extract video image" style="color:black">
                                                <i class="fas fa-camera-retro"></i>
                                            </a><br/>
                                            <a href="javascript:frameBackward()" title="Preceding frame" style="color:black">
                                                <i class="fas fa-step-backward"></i>
                                            </a><br/>
                                            <a href="javascript:frameForward()" title="Next frame" style="color:black">
                    ...
                    <%      if (videos.size()>1){ %>
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <div style="background: #f8f9fa; height: 270px; border-radius: 3px; padding: 3px;">
                                            <a href="javascript:addVideoImageToCollection('<%= videos.get(1) %>')" title="Add video image to collection" style="color:black">
                                                <i class="far fa-plus-square"></i>
                                            </a><br/>          
                                            <a href="javascript:getVideoImage('<%= videos.get(1) %>')" title="Extract video image" style="color:black">
                                                <i class="fas fa-camera-retro"></i>
                                            </a>
                                        </div>
                                    </td>
